...
class BreakdownContainer {
    ...
    constructor( mnomold :String?, tech1: String?, tech2: String?, tech3: String?, tech4: String?,
                 analisa: String?,problem: String?, jenisproblem: String?, estimasi: Long?, estimasijam: Long?,
                 estimasimenit: Long?,key:String?, start: Long?)
