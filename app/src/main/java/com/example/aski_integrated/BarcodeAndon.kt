        ...
        override fun doInBackground(vararg params: String): String {
            try {
                ...
                if (con == null) {
                    ...
                    val query = "INSERT INTO moldshop(start_andon,start_repair,finish_repair,closed_by_op,dept,no_mc,problem,jenis_problem,perbaikan,issued_by,pic) VALUES ($start,$start_repair,$finish_repair,${System.currentTimeMillis()},'MS','$mc','$problem','$jenisproblem','$perbaikan','$issuedby','$pic')"
