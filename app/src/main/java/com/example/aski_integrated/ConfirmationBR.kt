        ...
        override fun doInBackground(vararg params: String): String {
            try {
                ...
                if (con == null) {
                    ...
                    val query =
                        "INSERT INTO breakdown (mold,tech1,tech2,tech3,tech4,analisa, problem,jenisproblem,estimasi,start,perbaikan) VALUES ('$nomold','$tech1','$tech2','$tech3','$tech4','$analisa','$problem','$jenisproblem','$estimasi','$start','$perbaikan')"
